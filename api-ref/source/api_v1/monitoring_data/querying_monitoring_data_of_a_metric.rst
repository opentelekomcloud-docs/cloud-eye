...
-  Parameter description
   ...
   .. table:: **Table 2** Query parameter description
      ...
      +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | from            | Yes             | String          | Specifies the start time of the query. The value is a UNIX timestamp, in milliseconds.                                                                                                                                                                             |
      |                 |                 |                 |                                                                                                                                                                                                                                                                    |
      ...
      +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | dim             | Yes             | String          | Specifies the metric dimensions. A maximum of three metric dimensions are supported, and the dimensions are numbered from zero in the **dim.{i}=key,value** format. **key** cannot exceed 32 characters and **value** cannot exceed 256 characters.                |
      |                 |                 |                 |                                                                                                                                                                                                                                                                    |
      |                 |                 |                 | The following dimensions are only examples. For details about whether multiple dimensions are supported, see the :ref:`dimension description of each service <ces_03_0059>`.                                                                                       |
      |                 |                 |                 |                                                                                                                                                                                                                                                                    |
