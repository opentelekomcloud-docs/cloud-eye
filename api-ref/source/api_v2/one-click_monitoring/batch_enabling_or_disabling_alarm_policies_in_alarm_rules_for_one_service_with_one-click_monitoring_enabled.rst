:original_name: BatchUpdateOneClickAlarmPoliciesEnabledState.html

.. _BatchUpdateOneClickAlarmPoliciesEnabledState:
...
.. table:: **Table 3** Request body parameters
   ...
   +------------------+-----------------+------------------+--------------------------------------------------------------------------------------------+
   | enabled          | Yes             | Boolean          | Whether to enable the function. The value can be **true** (enable) or **false** (disable). |
   +------------------+-----------------+------------------+--------------------------------------------------------------------------------------------+
