:original_name: BatchEnableAlarmRules.html

.. _BatchEnableAlarmRules:
...
.. table:: **Table 3** Request body parameters
   ...
   +-----------------+-----------------+------------------+--------------------------------------------------------------------------+
   | alarm_enabled   | Yes             | Boolean          | Whether to generate alarms when the alarm triggering conditions are met. |
   +-----------------+-----------------+------------------+--------------------------------------------------------------------------+
