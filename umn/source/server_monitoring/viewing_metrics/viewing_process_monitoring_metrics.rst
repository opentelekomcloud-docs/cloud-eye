...
#. Hover your mouse over a graph. In the upper right corner, click |image2| to enlarge the graph for viewing detailed data.
   ...
   In the upper left corner, you can see six default monitoring periods: **1h**, **3h**, **12h**, **1d**, **7d**, and **30d**. You can also set **Select Range** to customize one to view historical monitoring data for any period during the last six months.

   In the upper left corner of the graph details page, locate **Period** and configure the rollup method.
