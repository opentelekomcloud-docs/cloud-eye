...
-  OS monitoring provides proactive and fine-grained OS monitoring for ECSs or BMSs installed with the Agent.
...
#. After five minutes, check whether the Agent status is **Running**.
