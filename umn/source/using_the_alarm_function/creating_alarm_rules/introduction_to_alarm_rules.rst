:original_name: en-us_topic_0015479880.html
...
You can flexibly create alarm rules on Cloud Eye. You can create an alarm rule for a specific metric or use the alarm template to create alarm rules in batches for multiple cloud service resources.
